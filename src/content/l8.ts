...
export const l8: Lesson = {
  ...
  quiz: [
    { q: "Which of these is the strongest candidate for insurance?",
    ...
    { q: "Why do sellers push cover on small, cheap items so hard?",
      options: [
    ...
    { q: "A policy has a very low premium and a very high excess. What is the risk?",
      options: [
