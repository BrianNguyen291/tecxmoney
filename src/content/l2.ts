...
export const l2: Lesson = {
  ...
  teach: [
    ...
    { kind: "h", text: "Slowly, in your favour" },
    ...
    { kind: "p", text: "A shortcut worth memorising is the **rule of 72**. Divide 72 by your interest rate and you get the years it takes to double. At 12%, money doubles in about 6 years. At 8%, about 9 years." },
    { kind: "h", text: "Very quickly, against you" },
    { kind: "p", text: "Now look at a loan app. The screen says: **borrow 10,000, repay 10,750 in 30 days**. A 7.5% fee. That sounds small next to a 15% bank loan, so people take it." },
    ...
    { kind: "callout", text: "The app is not 7.5% more expensive than the bank. It is roughly seven times more expensive. The trick is never a lie — it is a true number quoted over a period you did not notice.", tone: "no" },
  ...
  swipe: [
    ...
    { claim: "At 12% a year, money takes about six years to double.", answer: true,
      why: "The rule of 72: 72 divided by 12 is 6. Useful for doing this in your head before you agree to anything." },
