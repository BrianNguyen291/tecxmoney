...
export const l4: Lesson = {
  ...
  teach: [
    ...
    { kind: "h", text: "The machine underneath" },
    { kind: "p", text: "In a Ponzi scheme, nothing is invested. Your withdrawal is paid out of the deposits of whoever joined after you. It works perfectly while deposits grow, and fails the instant they slow — which is not a risk of the model, it is **arithmetic**." },
    ...
    { kind: "p", text: "**3. The strategy is a vibe.** 'AI forex arbitrage', 'crypto mining pools', 'offshore trading desks'. If they cannot explain where the profit comes from in one plain sentence, it is because there is no profit." },
    { kind: "p", text: "**4. Urgency.** Closing soon, limited slots, price rises Friday. Pressure exists to stop you asking the questions on this page." },
    { kind: "p", text: "**5. Withdrawals work — until they are big.** Small withdrawals are paid instantly and build trust. Then large ones need 'verification', a fee, or an upgrade." },
    ...
    { kind: "p", text: "Ask: **where does the profit come from, who pays it, and why would they?** Write the answer down in one sentence. If you cannot, you have your answer — and you have not spent anything to get it." },
  ],
  swipe: [
  ...
  quiz: [
    { q: "Which of these is the single strongest signal that something is a Ponzi scheme?",
      ...
      why: [
        ...
        "Correct. Paying for recruitment means new deposits are the revenue. That is the engine of the scheme, not a marketing choice.",
    ...
    { q: "A scheme has paid you three small withdrawals on time. What has that proved?",
      ...
      why: [
        ...
        "It proves the opposite of nothing about safety. Paying small amounts is the cheapest part of running the scheme.",
