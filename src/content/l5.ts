...
export const l5: Lesson = {
  ...
  quiz: [
    { q: "Your last six weeks: 22k, 9k, 25k, 11k, 30k, 12k. What should your fixed weekly commitments be built on?",
    ...
    { q: "What is the main job of the buffer pot?",
    ...
    { q: "A trader keeps stock money and household money in one wallet. What usually happens?",
      options: [
