...
export const l6: Lesson = {
  ...
  quiz: [
    { q: "Why can a SACCO often lend to someone a bank would refuse?",
      options: [
    ...
    { q: "Which question would tell you most about a SACCO's health?",
      options: [
    ...
    { q: "Your SACCO pays no dividend this year. What is the most likely explanation?",
      options: [
