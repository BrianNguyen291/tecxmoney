...
export const l1: Lesson = {
  ...
  teach: [
    ...
    { kind: "h", text: "Inflation is a price you pay without seeing a bill" },
  ...
  quiz: [
    ...
    { q: "Which money genuinely belongs in a 0% mobile wallet?",
      options: [
        "School fees due in two years",
        "Rent due at the end of this month",
        "A house deposit you are building over five years",
        "Retirement savings",
      ],
      correct: 1,
      why: [
