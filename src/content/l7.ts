...
export const l7: Lesson = {
  ...
  quiz: [
    { q: "The local currency falls from 100 to 50 per dollar. What happens to the price of an imported item?",
    ...
    { q: "Who is hurt most by a sharp devaluation?",
      options: [
    ...
    { q: "What is the difference between protecting yourself and speculating?",
      options: [
